...
Note that applying a dark appearances will make iOS tell the extension that the _color scheme_ is dark, while this may in fact not be true. This will lead to visual bugs, that require workarounds. See the <doc:Colors-Article> article for more information.
